...
const UserDashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        if (!ethereum) {
          throw new Error('Please install MetaMask to view your dashboard')
        }
        ...
        const [products, walletBal, sellerBal, purchaseHistory] = await Promise.all([
          getMyProducts(),
  ...
  const statCards = [
    {
      ...
      value: `${stats.walletBalance.toFixed(4)} ETH`,
      change: null as string | null,
    },
    {
      label: 'Earnings Balance',
      value: `${stats.sellerBalance.toFixed(4)} ETH`,
      change: null as string | null,
    },
    {
    ...
    {
      label: 'Total Sales',
      value: `${stats.totalSales.toFixed(4)} ETH`,
      change: null as string | null,
    },
  ]
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-2xl font-semibold text-white mt-5">Dashboard</h1>
